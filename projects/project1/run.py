...
(x_train_balanced, y_train_balanced, rm_column_index, idx_nan_percent, x_train_full, initial_w) = build_all(x_train=x_train, y_train=y_train, degree_pol=5)
...
x_test_standardized = prepare_test_data(x_test, rm_column_index, idx_nan_percent, degree=5)
